...
type ActionsType = RemoveTodolist | AddNewTodolistType | ChangeTodolistTitleType | ChangeTodolistFilterType | ChangeTodolistSortType
...
const changeTodolistSortAC = (todolistId: string, sort: SortValuesType) => (
